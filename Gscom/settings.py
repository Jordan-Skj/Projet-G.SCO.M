"""
Django settings for Gscom project.
...
WSGI_APPLICATION = 'Gscom.wsgi.application'
...
EMAIL_TIMEOUT = 15
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='gscom.montngafula@gmail.com')
